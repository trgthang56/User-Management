...
<html lang="en">
  <head>
    ...
    <title>Sau sẽ là trang landing page</title>
    <!-- base:css -->
    <link rel="stylesheet" href="{{ asset('template/management/vendors/typicons.font/font/typicons.css') }}">
    <link rel="stylesheet" href="{{ asset('template/management/vendors/css/vendor.bundle.base.css') }}">
    <!-- endinject -->
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{ asset('template/management/css/vertical-layout-light/style.css') }} ">
    <!-- endinject -->
    <link rel="shortcut icon" href="{{ asset('template/management/images/favicon.png') }}" />
  </head>
  <body>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('template/management/images/logo.svg') }}" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('template/management/images/logo-mini.svg') }}" alt="logo"/></a>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{ asset('template/management/images/faces/face4.jpg') }}" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{ asset('template/management/images/faces/face2.jpg') }}" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{ asset('template/management/images/faces/face3.jpg') }}" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
          ...
          <li class="nav-item">
            <div class="d-flex sidebar-profile">
              <div class="sidebar-profile-image">
                <img src="{{ asset('template/management/images/faces/face29.png') }}" alt="image">
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="template/management/images/faces/face30.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="template/management/images/faces/face31.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="template/management/images/faces/face32.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="template/management/images/faces/face33.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="template/management/images/faces/face34.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                                  <div class="font-weight-bold  mt-1">volkswagen</div>
                                </div>
    ...
    <!-- container-scroller -->
    <!-- base:js -->
    <script src="template/management/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src="template/management/js/off-canvas.js"></script>
    <script src="template/management/js/hoverable-collapse.js"></script>
    <script src="template/management/js/template.js"></script>
    <script src="template/management/js/settings.js"></script>
    <script src="template/management/js/todolist.js"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="template/management/vendors/progressbar.js/progressbar.min.js"></script>
    <script src="template/management/vendors/chart.js/Chart.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="template/management/js/dashboard.js"></script>
