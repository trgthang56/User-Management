<section>
    ...
    <form id="update-avatar-form" method="post" action="{{ route('profile.updateAvatar') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        @csrf
        @method('patch')
        ...
        <div class="flex items-center gap-4">
            <x-primary-button onclick="document.getElementById('update-avatar-form').submit(); return false;">{{ __('Save') }}</x-primary-button>
